...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-!=-6*6=hio@7phs)y88mq$bezocp)2n73h@o)8#cb3vawjxdl*')
...
DATABASE_URL = os.getenv('DATABASE_URL', 'postgresql://user:password@db:5432/webhook_db')
DATABASES = {
